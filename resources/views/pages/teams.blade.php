...
<!--begin::Head-->
<head><base href=""/>
    <title>Takımlar | Çağlı</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                        ...
                        <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                            <form id="toolbar_form_date" method="get" class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                                ...
                                <div class="d-flex align-items-center" style="margin-right: 1.25rem">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <input onchange="$('#toolbar_form_date').submit();" value="{{ $_GET['start_date'] }}" max="{{ date('Y-m-d') }}" class="form-control form-control-solid rounded rounded-end-0" name="start_date" type="date" placeholder="Başlangıç Tarihi" id="" />
                                    <!--end::Select-->
                                </div>
                                <!--end::Action wrapper-->
                                <!--begin::Action wrapper-->
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <input onchange="$('#toolbar_form_date').submit();" value="{{ $_GET['end_date'] }}" max="{{ date('Y-m-d') }}" class="form-control form-control-solid rounded rounded-end-0" name="end_date" type="date" placeholder="Bitiş Tarihi" id="" />
                                    <!--end::Select-->
                                </div>
                                <!--end::Action wrapper-->
                            </form>
                                                ...
                                                <div class="d-flex flex-stack">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
                                                            <a  class="text-dark fw-bold text-hover-primary fs-5">{{ $project->title }} ({{ tr_sales_between_dates(['type' => 'office', 'office_id' => $office->id, 'project_id' => $project->id, 'returns' => 'quantity', 'start_date' => $start_date, 'end_date' => $end_date]) }} Satış)</a>
                                                            <span class="text-muted fw-bold">{{ $office->title }}</span>
                                                        </div>
                                                        <!--end:Title-->
                                                    </div>
                                                    <!--begin:Info-->
                                                        ...
                                                        <div class="col-md-2 mt-7">
                                                            <div class="card card-bordered">
                                                                ...
                                                                <div class="card-body d-flex flex-center flex-column pt-12 p-9">
                                                                    ...
                                                                    <!--end::Avatar-->
                                                                    <!--begin::Name-->
                                                                    <a  class="fs-4 text-gray-800 text-hover-primary fw-bold mb-0">{{ $user->name.' '.$user->surname }}</a>
                                                                    <!--end::Name-->
                                                                    <!--begin::Position-->
                                                                    <div class="fw-semibold text-gray-400 mb-6">{{ $user->group_title }}</div>
                                                                    <!--end::Position-->
                                                                    <!--begin::Info-->
                                                                    <div class="d-flex flex-center flex-wrap">
                                                                        <!--begin::Stats-->
                                                                        <div class="border border-gray-300 border-dashed rounded min-w-80px py-3 px-4 mx-2 mb-3 text-center">
                                                                            <div class="fs-6 fw-bold text-gray-700">{{ tr_sales_between_dates(['type' => 'user', 'user_id' => $user->id, 'returns' => 'quantity', 'start_date' => $start_date, 'end_date' => $end_date]) }}</div>
...
<script>
    $(document).ready(function () {
        @if(request()->start_date)
            $('input[name=end_date]').attr('min', '{{ request()->start_date }}');
        @endif
        @if(request()->end_date)
            $('input[name=start_date]').attr('max', '{{ request()->end_date }}');
        @endif
    });
