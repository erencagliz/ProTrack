...
<!--begin::Head-->
<head><base href=""/>
    <title>Profil | Çağlı</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Profil</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                        ...
                                                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                            ...
                                                            <th class="text-end">Son Düzenlenme Tarihi</th>
                                                        </tr>
                                                        <!--end::Table row-->
                                                        </thead>
                                                        <!--end::Table head-->
                                            ...
                                            <div class="card-body d-flex flex-column">
                                                ...
                                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="target_list_table">
                                                    ...
                                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="text-end min-w-100px">Oluşturulma Tarihi</th>
                                                    </tr>
                                                    <!--end::Table row-->
                                                    </thead>
                                                    <!--end::Table head-->
