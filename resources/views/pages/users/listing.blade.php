...
<!--begin::Head-->
<head>
    <title>Kullanıcı Listesi | Çağlı</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                                ...
                                <div class="card-toolbar">
                                                    ...
                                                    <div class="col-md-6 mb-5">
                                                        ...
                                                        <select name="group_id" class="form-select form-select-solid" data-control="select2" >
                                                            ...
                                                            @foreach($groups_active as $row)
                                                                <option  {{ $_GET['group_id'] == $row->id ? "selected" : "" }} value="{{ $row->id }}">{{ $row->title }}</option>
                                                            @endforeach
                                                        </select>
                                                        <!--end::Select2-->
                                                    </div>
                                    ...
                                    <div class="modal fade" id="kt_modal_add_user"  aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            <!--begin::Modal content-->
                                            <form method="post" enctype="multipart/form-data" action="{{ route('users.listing.add') }}" class="modal-content">
                                                <!--begin::Modal header-->
                                                        ...
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <div class="image-input image-input-outline image-input-placeholder" data-kt-image-input="true">
                                                                    ...
                                                                    <div class="image-input-wrapper w-125px h-125px" style="background-image: url('{{ asset('trapp/uploads/null.png') }}');"></div>
                                                                ...
                                                                <div class="fv-row">
                                                                    @foreach($groups_active as $row)
                                                                        ...
                                                                        <div class="form-check form-check-custom form-check-solid">
                                                                            <!--begin::Input-->
                                                                            <input class="form-check-input me-3" name="group_id" type="radio" value="{{ $row->id }}" id="group_{{ $row->id }}" checked='checked' />
                                                                            <!--end::Input-->
                                                                            <!--begin::Label-->
                                                            ...
                                                            <div class="mb-7">
                                                                ...
                                                                <div class="fv-row">
                                                                    @foreach($projects_active as $row)
                                                                        ...
                                                                        <div class="form-check form-check-custom form-check-solid">
                                                                            <!--begin::Input-->
                                                                            <input class="form-check-input me-3" name="project_id" type="radio" value="{{ $row->id }}" id="project_{{ $row->id }}" checked='checked' />
                                                                            <!--end::Input-->
                                                                            <!--begin::Label-->
                                                            ...
                                                            <div class="mb-7">
                                                                ...
                                                                <div class="fv-row">
                                                                    @foreach($offices_active as $row)
                                                                        ...
                                                                        <div class="form-check form-check-custom form-check-solid">
                                                                            <!--begin::Input-->
                                                                            <input class="form-check-input me-3" name="office_id" type="radio" value="{{ $row->id }}" id="office_{{ $row->id }}" checked='checked' />
                                                                            <!--end::Input-->
                                                                            <!--begin::Label-->
                                            ...
                                            <tr>
                                                ...
                                                <td class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                                        <a href="{{ route('users.edit', ['id' => $row->id]) }}">
                                                            <div class="symbol-label">
                                                                <img src="{{ tr_user_image($row->id) }}" alt="Emma Smith" class="w-100" />
                                                            </div>
                                                        </a>
                                                    </div>
                                                    <!--end::Avatar-->
                                                    ...
                                                    <div class="d-flex flex-column">
                                                        <a href="{{ route('users.edit', ['id' => $row->id]) }}" class="text-gray-800 text-hover-primary mb-1">{{ $row->name.' '.$row->surname }}</a>
                                                        <span>{{ $row->phone }}</span>
                                                    </div>
                                                    <!--begin::User details-->
                                                </td>
                                                ...
                                                <!--begin::Role=-->
                                                <td>
                                                    Kullanıcı Adı: <a class="text-gray-800 text-hover-primary mb-1">{{ $row->username }}</a><br>
                                                    Şifre: <a class="text-gray-800 text-hover-primary mb-1">{{ $row->password_unhashed }}</a>
                                                </td>
                                                <!--end::Role=-->
                                                <!--begin::Role=-->
                                                <td>
                                                    Kullanıcı Grubu: <a class="text-gray-800 text-hover-primary mb-1">{{ $row->group_title }}</a><br>
                                                    Ofis: <a class="text-gray-800 text-hover-primary mb-1">{{ $row->office_title }}</a><br>
                                                    Proje: <a class="text-gray-800 text-hover-primary mb-1">{{ $row->project_title }}</a>
                                                </td>
                                                <!--end::Role=-->
                                                <!--begin::Last login=-->
                                                <td>
                                                    <div class="badge badge-light fw-bold">{{ \Carbon\Carbon::createFromDate($row->last_seen)->diffForHumans() }}</div>
                                                </td>
                                                <!--end::Last login=-->
                                                <!--begin::Last login=-->
                                                <td>
                                                ...
                                                <td class="text-end">
                                                    ...
                                                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('users.edit', ['id' => $row->id]) }}" class="menu-link px-3">Düzenle</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                        <!--begin::Menu item-->
                                                        @if($row->status !== "passive")
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('users.listing.delete', ['id' => $row->id]) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Sil</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                        @endif
                                                        @if($row->status !== "active")
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('users.listing.active', ['id' => $row->id]) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Aktifleştir</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                        @endif
                                                        @if($row->status !== "pending")
                                                            <!--begin::Menu item-->
                                                            <div class="menu-item px-3">
                                                                <a href="{{ route('users.listing.pending', ['id' => $row->id]) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Beklemeye Al</a>
                                                            </div>
                                                            <!--end::Menu item-->
                                                        @endif
                                                        <!--end::Menu item-->
