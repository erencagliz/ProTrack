...
<!--begin::Head-->
<head><base href=""/>
    <title>Kullanıcı Düzenle | Çağlı</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                                        ...
                                        <div class="form">
                                            ...
                                            <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" id="nameinput" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="İsim" value="{{ $user->name }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Input-->
                                                    <input type="text" id="surnameinput" name="surname" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Soyisim" value="{{ $user->surname }}" />
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                <!--begin::Input group-->
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" id="usernameinput" name="username" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Kullanıcı Adı" value="{{ $user->username }}" />
                                                    </div>
                                                    <!--end::Input-->
                                                </div>
                                                <!--end::Input group-->
                                                ...
                                                <div class="fv-row mb-7">
                                                    ...
                                                    <!--begin::Input-->
                                                    <div class="input-group">
                                                        <input type="text" id="passwordinput" name="password" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Şifre" value="{{ $detail->password }}" />
