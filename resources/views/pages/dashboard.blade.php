                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        ...
                        <div class="row g-5 g-xl-8">
                            ...
                            <div class="col-xl-4">
                                <!--begin::Statistics Widget 5-->
                                <a href="javascript:void(0);" class="card bg-dark hoverable card-xl-stretch mb-5 mb-xl-8">
                                    <!--begin::Body-->
                                    <div class="card-body">
                                ...
                                <div class="card card-xl-stretch mb-xl-8">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <!--begin::Menu 1-->
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637dfd010c724">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                ...
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div>
                                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637dfd010c724" data-allow-clear="true">
                                                                <option></option>
                                    ...
                                    <div class="card-body pt-5">
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <div class="d-flex flex-column">
                                                <a href="javascript:void(0);" class="text-dark text-hover-primary fs-6 fw-bold">Project Briefing</a>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <!--begin::Text-->
                                            <div class="d-flex flex-column">
                                                <a href="javascript:void(0);" class="text-dark text-hover-primary fs-6 fw-bold">Concept Design</a>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <!--begin::Text-->
                                            <div class="d-flex flex-column">
                                                <a href="javascript:void(0);" class="text-dark text-hover-primary fs-6 fw-bold">Functional Logics</a>
                                        ...
                                        <div class="d-flex align-items-center mb-7">
                                            ...
                                            <!--begin::Text-->
                                            <div class="d-flex flex-column">
                                                <a href="javascript:void(0);" class="text-dark text-hover-primary fs-6 fw-bold">Development</a>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <!--begin::Text-->
                                            <div class="d-flex flex-column">
                                                <a href="javascript:void(0);" class="text-dark text-hover-primary fs-6 fw-bold">Testing</a>
                                                    ...
                                                    <table class="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                                                            ...
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="{{ asset('trapp') }}/assets/media/svg/brand-logos/plurk.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="javascript:void(0);" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Brad Simmons</a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="{{ asset('trapp') }}/assets/media/svg/brand-logos/telegram.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="javascript:void(0);" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Popular Authors</a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="{{ asset('trapp') }}/assets/media/svg/brand-logos/vimeo.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="javascript:void(0);" class="text-dark fw-bold text-hover-primary mb-1 fs-6">New Users</a>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="{{ asset('trapp') }}/assets/media/svg/brand-logos/bebo.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="javascript:void(0);" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Active Customers</a>
                                                                <span class="text-muted fw-semibold d-block">Movie Creator</span>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="{{ asset('trapp') }}/assets/media/svg/brand-logos/kickstarter.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                                <a href="javascript:void(0);" class="text-dark fw-bold text-hover-primary mb-1 fs-6">Bestseller Theme</a>
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <!--begin::Menu 1-->
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637dfd012b081">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                    <div class="fs-5 text-dark fw-bold">Filter Options</div>
                                                </div>
                                                ...
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div>
                                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637dfd012b081" data-allow-clear="true">
                                                                <option></option>
                                                                <option value="1">Approved</option>
                                                                <option value="2">Pending</option>
                                                                <option value="2">In Process</option>
                                ...
                                <div class="card card-xl-stretch mb-xl-8">
                                    ...
                                    <div class="card-header align-items-center border-0 mt-4">
                                        ...
                                        <div class="card-toolbar">
                                            ...
                                            <!--begin::Menu 1-->
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_637dfd012f230">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                    <div class="fs-5 text-dark fw-bold">Filter Options</div>
                                                </div>
                                                ...
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div>
                                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_637dfd012f230" data-allow-clear="true">
                                                                <option></option>
                                                                <option value="1">Approved</option>
                                                                <option value="2">Pending</option>
                                                                <option value="2">In Process</option>
                                    ...
                                    <div class="card-body pt-3">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('{{ asset('trapp') }}/assets/media/stock/600x400/img-20.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('{{ asset('trapp') }}/assets/media/stock/600x400/img-19.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('{{ asset('trapp') }}/assets/media/stock/600x400/img-25.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <div class="d-flex align-items-sm-center">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('{{ asset('trapp') }}/assets/media/stock/600x400/img-24.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="d-flex align-items-center bg-light-warning rounded p-5 mb-7">
                                            ...
                                            <!--begin::Title-->
                                            <div class="flex-grow-1 me-2">
                                                <a href="javascript:void(0);" class="fw-bold text-gray-800 text-hover-primary fs-6">Group lunch celebration</a>
                                                <span class="text-muted fw-semibold d-block">Due in 2 Days</span>
                                            </div>
                                            <!--end::Title-->
                                            <!--begin::Lable-->
                                        ...
                                        <div class="d-flex align-items-center bg-light-success rounded p-5 mb-7">
                                            ...
                                            <!--begin::Title-->
                                            <div class="flex-grow-1 me-2">
                                                <a href="javascript:void(0);" class="fw-bold text-gray-800 text-hover-primary fs-6">Navigation optimization</a>
                                                <span class="text-muted fw-semibold d-block">Due in 2 Days</span>
                                            </div>
                                            <!--end::Title-->
                                            <!--begin::Lable-->
                                        ...
                                        <div class="d-flex align-items-center bg-light-danger rounded p-5 mb-7">
                                            ...
                                            <!--begin::Title-->
                                            <div class="flex-grow-1 me-2">
                                                <a href="javascript:void(0);" class="fw-bold text-gray-800 text-hover-primary fs-6">Rebrand strategy planning</a>
                                                <span class="text-muted fw-semibold d-block">Due in 5 Days</span>
                                            </div>
                                            <!--end::Title-->
                                            <!--begin::Lable-->
                                        ...
                                        <div class="d-flex align-items-center bg-light-info rounded p-5">
                                            ...
                                            <!--begin::Title-->
                                            <div class="flex-grow-1 me-2">
                                                <a href="javascript:void(0);" class="fw-bold text-gray-800 text-hover-primary fs-6">Product goals strategy</a>
