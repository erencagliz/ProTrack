...
<!--begin::Head-->
<head><base href=""/>
    <title>Ana Sayfa | Çağlı</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-xxl">
                        ...
                        <style>
                            .satislistesi > .satiskisisi:last-child {
                                margin-bottom: 0 !important;
                            }
                        </style>

                        <!--begin::Row-->
                        <div class="row mt-1 g-6 g-xl-9">
                            <!--begin::Col-->
                            <div class="col-lg-4">
                                <!--begin::Card-->
                                <div class="card card-flush h-lg-100">
                                    ...
                                    <div class="card-header mt-6">
                                        <!--begin::Card title-->
                                        <div class="card-title flex-column">
                                            <h3 class="fw-bold mb-1">Günlük Satış Listesi</h3>
                                            <div class="fs-6 text-gray-400">{{ $project->title }} Projesine ait günlük satışlar.</div>
                                        </div>
                                        <!--end::Card title-->
                                    </div>
                                    <!--end::Card toolbar-->
                                    <!--begin::Card body-->
                                    <div class="card-body d-flex flex-column p-9 pt-3 satislistesi">
                                        @php
                                            $daily = \App\Models\Sale::query()
                                            ->select('sales.*', \Illuminate\Support\Facades\DB::raw('SUM(sales.quantity) as quantity'))
                                            ->where(['sales.status' => 'active', 'sales.project_id' => $project->id])
                                            ->whereBetween('sales.created_at', [date('Y-m-d 00:00:00'), date('Y-m-d 23:59:59')])
                                            ->groupBy('sales.user_id')
                                            ->orderBy('sales.quantity', 'DESC')
                                            ->get();
                                        @endphp
                                        @if($daily->count() <= 0)
                                            <p class="text-danger">Hiç satış yok.</p>
                                        @else
                                            @foreach($daily as $sale)
                                                <!--begin::Item-->
                                                <div class="d-flex align-items-center mb-5 satiskisisi">
                                                    <!--begin::Avatar-->
                                                    <div class="me-5 position-relative">
                                                        <!--begin::Image-->
                                                        <div class="symbol symbol-35px symbol-circle">
                                                            <img alt="Pic" src="{{ tr_user_image($sale->user_id) }}" />
                                                        </div>
                                                        <!--end::Image-->
                                                    </div>
                                                    <!--end::Avatar-->
                                                    ...
                                                    <div class="fw-semibold">
                                                        <a href="javascript:void(0);" class="fs-5 fw-bold text-gray-900 text-hover-primary">{{ tr_user_fullname($sale->user_id) }}</a>
                                                        <div class="text-gray-400">8 Pending & 97 Completed Tasks</div>
                                                    </div>
                                                    <!--end::Details-->
                                                    <!--begin::Badge-->
                                                    <div class="badge badge-light ms-auto">{{ $sale->quantity }}</div>
                                                    <!--end::Badge-->
                                                </div>
                                                <!--end::Item-->
                                            @endforeach
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card card-flush h-lg-100">
                                    ...
                                    <div class="card-header mt-6">
                                        <!--begin::Card title-->
                                        <div class="card-title flex-column">
                                            <h3 class="fw-bold mb-1">Haftalık Satış Listesi</h3>
                                            <div class="fs-6 text-gray-400">{{ $project->title }} projesine ait haftalık satışlar.</div>
                                        </div>
                                        <!--end::Card title-->
                                    </div>
                                    <!--end::Card toolbar-->
                                    ...
                                    <div class="card-body d-flex flex-column p-9 pt-3 satislistesi">
                                        @php
                                            $weekly = \App\Models\Sale::query()
                                            ->select('sales.*', \Illuminate\Support\Facades\DB::raw('SUM(sales.quantity) as quantity'))
                                            ->where(['sales.status' => 'active', 'sales.project_id' => $project->id])
                                            ->whereBetween('sales.created_at', [date('Y-m-d 00:00:00', strtotime('monday this week')), date('Y-m-d 23:59:59', strtotime('sunday this week'))])
                                            ->groupBy('sales.user_id')
                                            ->orderBy('sales.quantity', 'DESC')
                                            ->get();
                                        @endphp
                                        ...
                                        @else
                                            ...
                                            <div class="d-flex align-items-center mb-5 satiskisisi">
                                                ...
                                                <!--begin::Details-->
                                                <div class="fw-semibold">
                                                    <a href="{{ route('reporting', ['user_id' => $sale->user_id]) }}" class="fs-5 fw-bold text-gray-900 text-hover-primary">{{ tr_user_fullname($sale->user_id) }}</a>
                                                    <div class="text-gray-400">8 Pending & 97 Completed Tasks</div>
                                                </div>
                                                <!--end::Details-->
                                                <!--begin::Badge-->
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="card card-flush h-lg-100">
                                    ...
                                    <div class="card-header mt-6">
                                        <!--begin::Card title-->
                                        <div class="card-title flex-column">
                                            <h3 class="fw-bold mb-1">Aylık Satış Listesi</h3>
                                            <div class="fs-6 text-gray-400">{{ $project->title }} projesine ait aylık satışlar.</div>
                                        </div>
                                        <!--end::Card title-->
                                    </div>
                                    <!--end::Card toolbar-->
                                    ...
                                    <div class="card-body d-flex flex-column p-9 pt-3 satislistesi">
                                        @php
                                            $monthly = \App\Models\Sale::query()
                                            ->select('sales.*', \Illuminate\Support\Facades\DB::raw('SUM(sales.quantity) as quantity'))
                                            ->where(['sales.status' => 'active', 'sales.project_id' => $project->id])
                                            ->whereBetween('sales.created_at', [date('Y-m-01 00:00:00'), date('Y-m-t 23:59:59')])
                                            ->groupBy('sales.user_id')
                                            ->orderBy('sales.quantity', 'DESC')
                                            ->get();
                                        @endphp
