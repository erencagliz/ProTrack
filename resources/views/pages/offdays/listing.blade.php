...
<!--begin::Head-->
<head>
    <title>İzinler | Triooz</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">İzinler</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">İzinler</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-title">
                                    ...
                                    <div class="d-flex align-items-center position-relative my-1">
                                        ...
                                        <!--end::Svg Icon-->
                                        <input type="text" data-kt-ecommerce-order-filter="search" id="search_input" class="form-control form-control-solid w-250px ps-14" placeholder="Ara..." />
                                    </div>
                                    <!--end::Search-->
                                </div>
                                <!--end::Card title-->
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        <!--end::Filter-->
                                        <!--begin::Add user-->
                                        <a href="{{ route('offdays.add') }}" class="btn btn-primary">
                            ...
                            <div class="card-body py-4">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    <tr style="" class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Giriş Tarihi</th>
                                        <th class="min-w-125px">Eski</th>
                                        <th class="min-w-125px">Dönem</th>
                                        <th class="min-w-125px">Yıllık İzin</th>
                                        <th class="min-w-125px">Ücretsiz İzin</th>
                                        <th></th>
                                    ...
                                    @php $hak = $yillik_izin_hakki = $yeni_sayi = $eski_sayi = 0; @endphp
                                    @foreach($users as $row)
                                        @php
                                            $tarih1 = date_create(date("Y-m-d"));
                                            $tarih2 = date_create(tr_user_details($row->id, 'work_start_date'));

                                            //tarihler arasındaki fark
                                            $diff = date_diff($tarih1,$tarih2);

                                            //Gün Sayısı
                                            $hesapla = $diff->format("%y");

                                             if($hesapla>=1 && $hesapla<=5) {
                                                $hesapla=$hesapla*14;
                                                $yillikHak=14;
                                            } else if($hesapla>=6 && $hesapla<=15) {
                                                $yeniYil=$hesapla-5;
                                                $hesapla=(5*14)+($yeniYil*20);
                                                $yillikHak=20;
                                            } else if($hesapla>=15){
                                                $yeniYil=$hesapla-15;
                                                $hesapla=(5*14)+(15*20)+($yeniYil*26);
                                                $yillikHak=26;
                                            } else {
                                                $yillikHak=0;
                                            }
                                            // Daha 1 yıllık olmadıysa gösterme bile
                                            $kalanGun=$hesapla<1 ? "0" : $hesapla-$row->yillik_izin_toplami;

                                            if($kalanGun>0 && $kalanGun>$yillikHak) {
                                                $eskiSay=$kalanGun-$yillikHak;
                                                $eski=$eskiSay;
                                                $yeni=$kalanGun-$eskiSay;
                                            } else {
                                                $eski="";
                                                $yeni="";
                                            }
                                            ...
                                            if($kalanGun<0) {
                                                $kalanGun="<b class='text-danger'>{$kalanGun}</b>";
                                            } else if($kalanGun==0) {
                                                $kalanGun="<b class='text-gray'>{$kalanGun}</b>";
                                            } else {
                                                $kalanGun="<b class='text-success'>{$kalanGun}</b>";
                                            }
                                        @endphp
                                        <tr>
                                            <td>{{ $row->id }}</td>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-5">
                                                        <!--begin::Title-->
                                                        <a class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ tr_user_fullname($row->id) }}</a>
                                                        <!--end::Title-->
                                                        <br>
                                                        {{ tr_project_title(tr_user_details($row->id, 'project_id')) }}
                                                        /
                                            ...
                                            <td>
                                                {{ tr_user_details($row->id, 'work_start_date') }}
                                            </td>
                                            <td>
                                                {!! $eski !!}
                                            </td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{ route('offdays.details', ['id'=> $row->id]) }}" class=" menu-link px-3">Detaylar</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                </div>
                                                <!--end::Menu-->
