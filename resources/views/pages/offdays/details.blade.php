...
<!--begin::Head-->
<head><base href=""/>
    <title>Detaylar | Triooz</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Detaylar</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Detaylar</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                        ...
                        <div class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                            <form id="toolbar_form_date" method="get" class="d-flex align-items-stretch overflow-auto pt-3 pt-lg-0">
                                ...
                                <div class="d-flex align-items-center" style="margin-right: 1.25rem">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <input onchange="$('#toolbar_form_date').submit();" value="{{ request()->start_date ? request()->start_date : date('Y-m-01') }}" max="{{ date('Y-m-d') }}" class="form-control form-control-solid rounded rounded-end-0" name="start_date" type="date" placeholder="Başlangıç Tarihi" id="" />
                                    <!--end::Select-->
                                </div>
                                <!--end::Action wrapper-->
                                <!--begin::Action wrapper-->
                                <div class="d-flex align-items-center">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Select-->
                                    <input onchange="$('#toolbar_form_date').submit();" value="{{ request()->end_date ? request()->end_date : date('Y-m-t') }}" max="{{ date('Y-m-d') }}" class="form-control form-control-solid rounded rounded-end-0" name="end_date" type="date" placeholder="Bitiş Tarihi" id="" />
                                    <!--end::Select-->
                                </div>
                                <!--end::Action wrapper-->
                            </form>
                            ...
                            <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                ...
                                <div class="card-title">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                            <a>
                                                <div class="symbol-label">
                                                    <img src="{{ tr_user_image(request()->id) }}" alt="Ethan Wilder" class="w-100" />
                                                </div>
                                            </a>
                                        </div>
                                        <!--end::Avatar-->
                                        <div class="ms-5">
                                            <!--begin::Title-->
                                            <a class="text-gray-800 text-hover-primary fs-5 fw-bold">{{ tr_user_fullname(request()->id) }}</a>
                                            <!--end::Title-->
                                            <br>
                                            <span class="text-gray-800 text-hover-primary fs-6 fw-bold">
                                                {{ tr_project_title(tr_user_details(request()->id, 'project_id')) }}
                                                /
                                                {{ tr_office_title(tr_user_details(request()->id, 'office_id')) }}
                                            </span>
                                        </div>
                                    </div>
                                </div>
