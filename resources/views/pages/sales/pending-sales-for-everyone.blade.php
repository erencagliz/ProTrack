...
<!--begin::Head-->
<head><base href=""/>
    <title>Bekleyen Satışlar | Triooz</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Bekleyen Satışlar</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Bekleyen Satışlar</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                                            ...
                                            <td class="text-end">
                                                <div class="form-check form-switch form-check-custom form-check-solid justify-content-end">
                                                    <form method="post">
                                                        ...
                                                        <!--begin::Radio group-->
                                                        <div class="btn-grou" data-kt-buttons="true" data-kt-buttons-target="[data-kt-button]">

                                                            <!--begin::Radio-->
                                                            <label class="btn btn-outline btn-color-muted btn-active-danger" data-kt-button="true">
                                                                <!--begin::Input-->
                                                                <input class="btn-check" type="radio" name="status" value="passive"/>
                                                                <!--end::Input-->
                                                                Pasif
                                                            </label>
                                                            <!--end::Radio-->
                                                            ...
                                                            <label class="btn btn-outline btn-color-muted btn-active-success" data-kt-button="true">
                                                                <!--begin::Input-->
                                                                <input class="btn-check" type="radio" name="status" value="active" />
                                                                <!--end::Input-->
                                                                Aktif
                                                            </label>
                                                            <!--end::Radio-->
    ...
    $('input[type=radio]').change(function (e) {
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data === 'true') {
                    toastr.success("Satış durumu başarıyla değiştirildi.");
                } else {
                    toastr.error("Satış durumu değiştirilemedi. Lütfen tekrar deneyiniz.");
                }
            }
        });
    });
