...
<!--begin::Head-->
<head>
    <title>Molalar | Triooz</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Molalar</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Molalar</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                                            ...
                                            <div class="py-5" data-kt-user-table-filter="form">
                                                ...
                                                <div class="px-7 py-5 row" data-kt-user-table-filter="form">
                                                    ...
                                                    <div class="d-flex justify-content-end">
                                                        <a href="{{ route('pauses') }}" class="btn btn-light mx-3 fw-semibold px-6" >Sıfırla</a>
                            ...
                            <div class="card-body py-4">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-125px">Mola Süresi</th>
                                        <th class="min-w-125px">Mola Başlama Tarihi</th>
                                        <th class="min-w-125px">Mola Bitiş Tarihi</th>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="ms-5">
                                                        ...
                                                        <!--end::Title-->
                                                        <br>
                                                        {{ tr_user_project_title($row->user_id) }}
                                                        /
                                                        {{ tr_user_office_title($row->user_id) }}
                                                    </div>
                                                </div>
                                            </td>
                                            <!--end::User=-->
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    @if($row->status !== "passive")
                                                        ...
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('pause.listing.delete', ['id' => $row->id]) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Sil</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    @endif
                                                </div>
