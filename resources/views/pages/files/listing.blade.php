                        ...
                        <div class="row g-7">
                            ...
                            <div class="col-lg-6 col-xl-3">
                                ...
                                <div class="card card-flush">
                                    ...
                                    <!--end::Card header-->
                                    <!--begin::Card body-->
                                    <form enctype="multipart/form-data" method="post" action="{{ route('files.listing.post') }}" class="card-body pt-5">
                                        @csrf
                                        <!--begin::Separator-->
                                                ...
                                                <div class="d-flex flex-stack py-4">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div class="symbol symbol-40px symbol-circle">
                                                            <img alt="Pic" src="{{ tr_user_image($row->id) }}" />
                                                        </div>
                                                        <!--end::Avatar-->
                                                        <!--begin::Details-->
                                                        <div class="ms-4">
                                                            <a href="{{ route('files.listing', ['user_id' => $row->id]) }}" class="fs-6 fw-bold text-gray-900 text-hover-primary mb-2">{{ $row->name.' '.$row->surname }}</a>
                                                            <div class="fw-semibold fs-7 text-muted">{{ tr_project_title(tr_user_details($row->id, 'project_id')) }} / {{ tr_office_title(tr_user_details($row->id, 'office_id')) }}</div>
                                                        </div>
                                                        <!--end::Details-->
                                                    </div>
                                                    <!--end::Details-->
                                        ...
                                        <div class="card-body pt-5">
                                            ...
                                            <div class="d-flex gap-7 align-items-center">
                                                ...
                                                <div class="symbol symbol-circle symbol-100px">
                                                    <img src="{{ tr_user_image($user_id) }}" alt="image" />
                                                </div>
                                                <!--end::Avatar-->
                                                <!--begin::Contact details-->
                                                <div class="d-flex flex-column gap-2">
                                                    <!--begin::Name-->
                                                    <h3 class="mb-0">{{ tr_user_fullname($user_id) }}</h3>
                                                    <!--end::Name-->
                                                    <!--begin::Email-->
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a class="text-muted text-hover-primary">{{ tr_user_username($user_id) }}</a>
                                                    </div>
                                                    <!--end::Email-->
                                                    <!--begin::Phone-->
                                                    <div class="d-flex align-items-center gap-2">
                                                        ...
                                                        <!--end::Svg Icon-->
                                                        <a class="text-muted text-hover-primary">{{ tr_user_phone($user_id) }}</a>
                                                    </div>
                                                    <!--end::Phone-->
                                                </div>
                                                <!--end::Contact details-->
                                    ...
                                    <div class="card card-flush h-lg-100" id="kt_contacts_main">
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="text-center px-4">
                                                <img class="mw-100 mh-300px" alt="" src="{{ asset('trapp/') }}/assets/media/illustrations/sketchy-1/5.png" />
                                            </div>
                                            <!--end::Illustration-->
                                        </div>
                                        <!--end::Card body-->
