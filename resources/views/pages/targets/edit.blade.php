...
<!--begin::Head-->
<head><base href=""/>
    <title>Hedef Düzenle | Triooz</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Hedef Düzenle</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Hedef Düzenle</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
            ...
            <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
                ...
                <div class="post d-flex flex-column-fluid" id="kt_post">
                    ...
                    <div id="kt_content_container" class="container-fluid">
                        <form method="post" action="{{ route('targets.edit.edit_post') }}" class="card">
                                ...
                                <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                    ...
                                    <div class="fv-row mb-7">
                                        ...
                                        <select name="type" class="form-select form-select-solid" data-control="select2" >
                                            ...
                                            <option {{ $target->type == "team" ? "selected" : "" }} value="team">Takım Hedefi</option>
                                            <option {{ $target->type == "user" ? "selected" : "" }} value="user">Kişisel Hedef</option>
                                            <option {{ $target->type == "project" ? "selected" : "" }} value="project">Proje Hedefi</option>
                                        </select>
                                        <!--end::Select2-->
                                        <!--end::Input-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-5" id="project_container">
                                        ...
                                        <select name="project_id" class="form-select form-select-solid" data-control="select2" >
                                            ...
                                            @foreach($projects as $row)
                                                <option {{ $target->project_id == $row->id ? "selected" : "" }} value="{{ $row->id }}">{{ $row->title }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-5" id="office_container">
                                        ...
                                        <select name="office_id" class="form-select form-select-solid" data-control="select2" >
                                            ...
                                            @foreach($offices as $row)
                                                <option {{ $target->office_id == $row->id ? "selected" : "" }} value="{{ $row->id }}">{{ $row->title }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-5" id="user_container">
                                        ...
                                        <select name="user_id" class="form-select form-select-solid" data-control="select2" >
                                            ...
                                            @foreach($users as $row)
                                                <option {{ $target->user_id == $row->id ? "selected" : "" }}  value="{{ $row->id }}">{{ $row->name.' '.$row->surname }}</option>
                                            @endforeach
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <select name="target_type" class="form-select form-select-solid" data-control="select2" >
                                            <option selected value="">Seçiniz...</option>
                                            <option {{ $target->target_type == "quantity" ? "selected" : "" }} value="quantity">Satış</option>
                                            <option {{ $target->target_type == "point" ? "selected" : "" }} value="point">Puan</option>
                                        </select>
                                        <!--end::Select2-->
                                    </div>
                                    <!--end::Input group-->
                                    ...
                                    <div class="mb-5">
                                        ...
                                        <!--begin::Select2-->
                                        <input type="number" name="target" class="form-control form-control-solid" value="{{ $target->target }}" placeholder="Hedef" />
                                        <!--end::Select2-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-5">
                                        ...
                                        <!--begin::Select2-->
                                        <input type="date" name="start_date" class="form-control form-control-solid" value="{{ $target->start_date }}" placeholder="Başlangıç Tarihi" />
                                        <!--end::Select2-->
                                    </div>
                                    <!--end::Input group-->
                                    <!--begin::Input group-->
                                    <div class="mb-5">
                                        ...
                                        <!--begin::Select2-->
                                        <input type="date" name="end_date" class="form-control form-control-solid" value="{{ $target->end_date }}" placeholder="Bitiş Tarihi" />
                                        <!--end::Select2-->
                                    </div>
                                    <!--end::Input group-->
                                </div>
...
<script>
    $(document).ready(function () {
        ...
        if ($('select[name=type]').find(':selected').val() === 'team') {
            $('#user_container').hide();
            $('#office_container').show();
            $('#project_container').show();
        } else if ($('select[name=type]').find(':selected').val() === 'user') {
            $('#user_container').show();
            $('#office_container').hide();
            $('#project_container').hide();
        } else if ($('select[name=type]').find(':selected').val() === 'project') {
            $('#user_container').hide();
            $('#office_container').hide();
            $('#project_container').show();
        } else {
