...
<!--begin::Head-->
<head><base href=""/>
    <title>Primler | Triooz</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Primler</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Primler</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                                    ...
                                    <form method="get" action="" id="filter_form" class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true" style="">
                                        ...
                                        <div class="px-7 py-5 row" data-kt-user-table-filter="form">
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <a href="{{ route('bonus.listing') }}" class="btn btn-light mx-3 fw-semibold px-6" >Sıfırla</a>
                            ...
                            <div class="card-body pt-0">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                    ...
                                    @foreach($users as $row)
                                        @php
                                            $sales_quantity = tr_sales_between_dates(['type' => 'user', 'user_id' => $row->id, 'start_date' => $start_date, 'end_date' => $end_date, 'returns' => 'quantity']);
                                            $sales_point = tr_sales_between_dates(['type' => 'user', 'user_id' => $row->id, 'start_date' => $start_date, 'end_date' => $end_date, 'returns' => 'point']);
                                            $bonus = \App\Models\Bonus::query()->where(['type' => 'monthly', 'project_id' => $row->project_id])->whereRaw("".$sales_point." BETWEEN min_point AND max_point")->first();
                                            $bonus_point = 0;
                                            if($bonus->multiplier > 0) {
                                                $deger1 = $sales_point - $bonus->min_point;
                                                $deger2 = floor($deger1 / $bonus->multiplier);
                                                $bonus_point = $deger2 * $bonus->bonus_tl;
                                            }
                                            $total_prim = $bonus_point + $bonus->fix_tl + $bonus->min_tl;
                                            $real_prim = $bonus_point + $bonus->min_tl;
                                        @endphp
                                        <!--begin::Table row-->
                                        <tr>
                                            <!--begin::Checkbox-->
