...
<!--begin::Head-->
<head>
    <title>Ofisler | Triooz</title><meta name="viewport" content="width=device-width, initial-scale=1.0"/>
    <meta charset="utf-8" />
        ...
        <div class="wrapper d-flex flex-column flex-row-fluid" id="kt_wrapper">
                ...
                <div class="toolbar d-flex align-items-stretch">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex justify-content-center flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bold fs-3 mb-0">Ofisler</h1>
                            <!--end::Title-->
                            <!--begin::Breadcrumb-->
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">Ofisler</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="modal fade" id="kt_modal_add_user"  aria-hidden="true">
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            <!--begin::Modal content-->
                                            <form method="post" enctype="multipart/form-data" action="{{ route('offices.listing.add_post') }}" class="modal-content">
                                                <!--begin::Modal header-->
                                                <div class="modal-header" id="kt_modal_add_user_header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bold">Ofis Ekle</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                ...
                                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                    ...
                                                    <div class="form">
                                                        ...
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                <!--begin::Label-->
                                                                <label class="required fw-semibold fs-6 mb-2">Adres</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Adres" value="" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                        </div>
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    @foreach($offices as $row)
                                        ...
                                        <tr>
                                            ...
                                            <!--begin::Role=-->
                                            <td>
                                                <a class="text-gray-800 text-hover-primary mb-1">{{ $row->address }}</a><br>
                                            </td>
                                            <!--end::Role=-->
                                            <!--begin::Last login=-->
                                            <td>
                                            ...
                                            <td class="text-end">
                                                ...
                                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                                    ...
                                                    @if($row->status !== "passive")
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('offices.listing.delete', ['id' => $row->id]) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Sil</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    @endif
                                                    @if($row->status !== "active")
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('offices.listing.active', ['id' => $row->id]) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Aktifleştir</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    @endif
                                                    @if($row->status !== "pending")
                                                        <!--begin::Menu item-->
                                                        <div class="menu-item px-3">
                                                            <a href="{{ route('offices.listing.pending', ['id' => $row->id]) }}" class="menu-link px-3" data-kt-users-table-filter="delete_row">Beklemeye Al</a>
                                                        </div>
                                                        <!--end::Menu item-->
                                                    @endif
                                                    <!--end::Menu item-->
            ...
            @foreach($offices as $row)
                ...
                <div class="modal fade" id="kt_modal_office_edit_{{ $row->id }}"  aria-hidden="true">
                    ...
                    <div class="modal-dialog modal-dialog-centered mw-650px">
                        <!--begin::Modal content-->
                        <form method="post" enctype="multipart/form-data" action="{{ route('offices.listing.edit_post') }}" class="modal-content">
                            @csrf
                            <input type="hidden" name="id" value="{{ $row->id }}">
                            <!--begin::Modal header-->
                            <div class="modal-header" id="kt_modal_add_user_header">
                                <!--begin::Modal title-->
                                <h2 class="fw-bold">Ofis Düzenle</h2>
                                <!--end::Modal title-->
                                <!--begin::Close-->
                                <div class="btn btn-icon btn-sm btn-active-icon-primary" data-kt-users-modal-action="close">
                                    <!--begin::Svg Icon | path: icons/duotune/arrows/arr061.svg-->
                                ...
                                <div class="form">
                                    ...
                                    <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                        ...
                                        <div class="fv-row mb-7">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" name="address" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Adres" value="{{ $row->address }}" />
                                            <!--end::Input-->
                                        </div>
                                        <!--end::Input group-->
                                    </div>
