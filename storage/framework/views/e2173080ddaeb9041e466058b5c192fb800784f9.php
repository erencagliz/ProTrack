                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-5">
                                ...
                                <select name="product_id" class="form-select form-select-solid" data-control="select2" >
                                    ...
                                    <?php $products = \App\Models\Product::query()->where(['status' => 'active', 'project_id' => tr_user_details(Auth::user()->id, 'project_id')])->get(); ?>
                                    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($product->id); ?>"><?php echo e($product->name); ?> (<?php echo e($product->title); ?>)</option>
...
<?php /**PATH C:\Users\Spafoni\PhpstormProjects\time.triooz.com\resources\views/includes/drawers.blade.php ENDPATH**/ ?>