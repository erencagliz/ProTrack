...
<head><base href=""/>
    ...
    <link href="<?php echo e(asset('trapp')); ?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet" type="text/css" />
                                                    ...
                                                    <table class="table table-row-dashed table-row-gray-200 align-middle gs-0 gy-4">
                                                            ...
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="<?php echo e(asset('trapp')); ?>/assets/media/svg/brand-logos/plurk.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="<?php echo e(asset('trapp')); ?>/assets/media/svg/brand-logos/telegram.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="<?php echo e(asset('trapp')); ?>/assets/media/svg/brand-logos/vimeo.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="<?php echo e(asset('trapp')); ?>/assets/media/svg/brand-logos/bebo.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <div class="symbol symbol-45px me-2">
																				<span class="symbol-label">
																					<img src="<?php echo e(asset('trapp')); ?>/assets/media/svg/brand-logos/kickstarter.svg" class="h-50 align-self-center" alt="" />
																				</span>
                                                                </div>
                                                            </td>
                                                            <td>
                                    ...
                                    <div class="card-body pt-3">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            ...
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('<?php echo e(asset('trapp')); ?>/assets/media/stock/600x400/img-20.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('<?php echo e(asset('trapp')); ?>/assets/media/stock/600x400/img-19.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <div class="d-flex align-items-sm-center mb-7">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('<?php echo e(asset('trapp')); ?>/assets/media/stock/600x400/img-25.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-row-fluid flex-wrap align-items-center">
                                        ...
                                        <div class="d-flex align-items-sm-center">
                                            <!--begin::Symbol-->
                                            <div class="symbol symbol-60px symbol-2by3 me-4">
                                                <div class="symbol-label" style="background-image: url('<?php echo e(asset('trapp')); ?>/assets/media/stock/600x400/img-24.jpg')"></div>
                                            </div>
                                            <!--end::Symbol-->
                                            <!--begin::Title-->
                                            <div class="d-flex flex-row-fluid flex-wrap align-items-center">
...
<script src="<?php echo e(asset('trapp')); ?>/assets/plugins/custom/fullcalendar/fullcalendar.bundle.js"></script>
...
<?php /**PATH C:\Users\Spafoni\PhpstormProjects\time.triooz.com\resources\views/pages/dashboard.blade.php ENDPATH**/ ?>